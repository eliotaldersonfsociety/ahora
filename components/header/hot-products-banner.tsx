  ...
  return (
    <div className="w-full">
      <button
        ...
        className="flex items-center justify-center w-full py-1.5 text-sm font-medium bg-gradient-to-r from-orange-500 to-orange-700 text-white transition-colors duration-200"
      >
              ...
              {hotProducts.map((product) => (
                ...
                >
                  <div className="relative mb-2 aspect-square w-full">
                    ...
                    />
                    <Badge className="absolute top-2 right-2 bg-sky-500 text-white text-xs px-1 py-0.5">
                      Hot
                    </Badge>
                  </div>
